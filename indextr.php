      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            ...
            <p class="fst-italic">
              Teknoloji ve yaşam tutkularını paylaşmaya karar veren bir grup kız.
              Gerekli bilgileri elde etmek için web geliştirme <strong>Re:coded</strong> ve
              <strong>Flatiron school</strong> okulundaki en güzel ve faydalı Bootcamp'lardan birine katıldık. ve sonra
              girişimimizi kurduk.
            </p>
      ...
      <section id="services" class="services">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2>Hizmetlerimiz</h2>
            <!-- <p  style="text-align:center">اطلع على خدماتنا</p> -->
          </div>
       <div class="row">
